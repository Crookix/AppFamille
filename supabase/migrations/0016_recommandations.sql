-- ---------------------------------------------------------------------------
-- 0016 — Reco : ce que la famille se recommande
--
-- POURQUOI LE SAUT DE NUMÉRO
-- --------------------------
-- Le dépôt s'arrête à `0013`, mais le journal `_tribu_migrations` du projet
-- Supabase porte déjà `0014_espace_nounou.sql` et
-- `0015_politiques_nounou_alignees.sql`, appliquées le 14 septembre 2026 et
-- dont les fichiers ne sont pas encore dans le dépôt. Numéroter cette
-- migration `0014` aurait donné deux `0014` différents une fois les deux
-- travaux réunis, et un ordre de rejeu différent de celui qu'a connu la
-- production. Le trou est volontaire : il se refermera quand l'espace nounou
-- sera committé.
--
-- POURQUOI
-- --------
